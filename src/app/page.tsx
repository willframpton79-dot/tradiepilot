...
import { stats, invoices } from "@/lib/sampleData";
...
import { Bell, DollarSign, Phone, Send, AlertTriangle, Clock, TrendingUp, Lightbulb } from "lucide-react";

export default function DashboardPage() {
  const { profitAlerts, hotLeads } = insightsData;
  return (
    <div className="p-4 lg:p-6 pb-24 lg:pb-6">
      ...
      >
        ...
        <div className="space-y-3">
          {profitAlerts.filter(a => a.is_active).map((alert, index) => {
            const alertStyles = {
