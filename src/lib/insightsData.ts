...
const insightsData: {
  ...
  profitAlerts: [
    {
      ...
      severity: 'high',
      title: 'Rooftop Terrace Construction is 8% over budget',
      description: 'Structural issues in support required 24 hours of emergency welding and additional engineering sign-off, costing $14,200 more than quoted.',
      job_id: 'job_003',
      job_title: 'Rooftop Terrace Construction',
      customer: 'Pacific Retail Partners',
      recommendation: 'Review variation process with Pacific Retail Partners. Ensure structural inspections are completed prior to final quote on future terrace builds.',
      is_active: true,
    },
    {
      id: 'alert_002',
  ...
  hotLeads: [
    {
      ...
      job_title: 'Commercial Bathroom Fitout Expansion',
    ...
    },
    {
      ...
      job_title: 'Office Electrical Upgrade Ph 2',
    ...
    },
    {
      ...
      job_title: 'Rooftop Terrace Extension',
  ...
  suburbHotspots: [
    { suburb: 'Pyrmont', tier: 'Prime', total_revenue: 185000, total_margin: 77700, avg_margin_pct: 42.0, job_count: 1, recommendation: 'Target commercial bathroom fitouts in heritage woolstores.', postcode: '2009' },
    { suburb: 'Parramatta', tier: 'Growth', total_revenue: 210000, total_margin: 107100, avg_margin_pct: 51.0, job_count: 1, recommendation: 'Focus on commercial landscaping and light industrial upgrades.', postcode: '2150' },
    { suburb: 'Surry Hills', tier: 'Prime', total_revenue: 340000, total_margin: 129200, avg_margin_pct: 38.0, job_count: 1, recommendation: 'High demand for high-end office electrical upgrades.', postcode: '2010' },
    { suburb: 'North Sydney', tier: 'Monitor', total_revenue: 92000, total_margin: -7360, avg_margin_pct: -8.0, job_count: 1, recommendation: 'Review refurb pricing. Account for structural contingencies in terrace builds.', postcode: '2060' },
  ],
  marketingTips: [
